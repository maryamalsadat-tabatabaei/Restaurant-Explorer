...
import { Breadcrumb, BreadcrumbItem,Button, FormGroup, Label, Input, FormText,Col, Row,FormFeedback } from 'reactstrap';
import { Control, Form, Errors, actions } from 'react-redux-form';
import LocationMap from './LocationComponent';
//import Mapgl from './MapglComponent';
        ...
        <div className="container">
            <div className="row row-content">
                ...
                <div className="col-12 col-md-4">
                        ...
                        HONG KONG<br />
                        <i className="fa fa-phone mt-4"></i>: +852 1234 5678<br />
      ...
      />
            ...
            <div className="row row-content">
                <div className="col-12">
                    ...
                    <p>Aenean massa diam, viverra vitae luctus sed, gravida eget est. Etiam nec ipsum porttitor,
                    <br/> consequat libero eu, dignissim eros. Nulla auctor lacinia enim id mollis.</p>
                </div>
                <div className="col-12 col-md-6 offset-md-3">
                    <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                      ...
                      <FormGroup check>
                        <Label check>
                          <Control.checkbox model=".checkbox" name="checkbox"
